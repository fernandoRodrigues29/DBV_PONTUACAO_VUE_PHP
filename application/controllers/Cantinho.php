    ...
    public function inserir(){
        ...
        try {
            ...
            //validação
              ...
              $this->form_validation->set_rules('presenca', 'presenca', 'required|trim|min_length[1]|max_length[100]');
              $this->form_validation->set_rules('hino', 'hino', 'required|trim|min_length[1]|max_length[100]');
              $this->form_validation->set_rules('uniforme', 'uniforme', 'required|trim|min_length[1]|max_length[100]');
              $this->form_validation->set_rules('atividades', 'atividades', 'required|trim|min_length[1]|max_length[100]');
            ...
            $presenca = $this->sanitizeString($dados['presenca']);
            $hino = $this->sanitizeString($dados['hino']);
            $uniforme = $this->sanitizeString($dados['uniforme']);
            $atividades = $this->sanitizeString($dados['atividades']);
